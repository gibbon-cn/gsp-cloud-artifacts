...
declare var mxForceIncludes: boolean;
...
/**
    ...
    */
declare function mxPanningManager(graph: any): void;
...
/**
    * Creates a new image declare instance to be used with an declare canvas. Here
...
/**
    ...
    */
declare class mxRadialTreeLayout extends mxCompactTreeLayout
{
    constructor(graph: any);
    /**
        * Returns a boolean indicating if the given <mxCell> should be ignored as a
...
declare interface Value extends Object
{
    nodeName: string;
}
/**
...
declare class mxEdgeSegmentHandler extends mxElbowEdgeHandler
{
    constructor(state: any);
    /**
...
declare var mxHierarchicalEdgeStyle: {
    ORTHOGONAL: number;
    POLYLINE: number;
    STRAIGHT: number;
    CURVE: number;
