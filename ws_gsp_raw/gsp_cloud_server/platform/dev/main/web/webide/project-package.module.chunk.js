webpackJsonp(["project-package.module"],{

/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"sourceMap\":false}!./src/assets/primeng/css/primeng.min.css":
...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"sourceMap\":false}!./src/assets/primeng/themes/omega/theme.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/css/images/color.png":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/css/images/line.gif":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/themes/omega/fonts/roboto-v15-latin-regular.eot":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/themes/omega/fonts/roboto-v15-latin-regular.svg":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "roboto-v15-latin-regular.5e809c17f25d1cf3fb68.svg";

/***/ }),

/***/ "./src/assets/primeng/themes/omega/fonts/roboto-v15-latin-regular.ttf":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/themes/omega/fonts/roboto-v15-latin-regular.woff":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/assets/primeng/themes/omega/fonts/roboto-v15-latin-regular.woff2":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/packages/project-wizard/package.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectWizardPackage", function() { return ProjectWizardPackage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_projectwizardpackageview__ = __webpack_require__("./src/packages/project-wizard/views/projectwizardpackageview.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_projectimportpackageview__ = __webpack_require__("./src/packages/project-wizard/views/projectimportpackageview.ts");
...
var ProjectWizardPackage = (function (_super) {
    __extends(ProjectWizardPackage, _super);
    function ProjectWizardPackage(gsp, cfr, injector) {
    ...
    ProjectWizardPackage.prototype.activate = function (state) {
        var _this = this;
        this.gsp.eventBus.on(null, null, 'Command:newFrontProject', this, function () { return _this.showModal(3, state, 'Create Form Project'); });
        this.gsp.eventBus.on(null, null, 'Command:newProject', this, function () { return _this.showModal(1, state, 'Create GSP Project'); });
        this.gsp.eventBus.on(null, null, 'Command:deleteProject', this, function () { return _this.deleteProject(); });
        this.gsp.eventBus.on(null, null, 'Command:newProjectImport', this, function () { return _this.showModal(2, state, 'Import Project'); });
    };
    ProjectWizardPackage.prototype.addNewTreeNode = function (nodeInfo) {
    ...
    ProjectWizardPackage.prototype.refreshFileTree = function () {
        this.gsp.eventBus.requestFor('FileTreePanelPackage', 'projectCreate', 'AccessFileTree', { action: '5' }, function () {
            console.log('event has been deal done');
        });
    };
    ProjectWizardPackage.prototype.deleteFileTree = function () {
        this.gsp.eventBus.requestFor('FileTreePanelPackage', 'projectCreate', 'AccessFileTree', { action: '4' }, function () {
            console.log('event has been deal done');
        });
    };
    ProjectWizardPackage.prototype.showModal = function (tag, state, title) {
        var _this = this;
        // const commonComponent = <ModelcommonComponent>this.packageView.getElement().instance;
        if (tag === 1) {
            var packageView = new __WEBPACK_IMPORTED_MODULE_1__views_projectwizardpackageview__["ProjectWizardPackageView"](state, this.cfr, this.injector);
            var ele_1 = packageView.getElement();
            var comp_1 = ele_1.instance;
            comp_1.createProjectSuccess.subscribe(function (nodeInfo) {
                if (nodeInfo === 1) {
                    _this.refreshFileTree();
                }
                else {
                    _this.addNewTreeNode(nodeInfo);
                }
            });
            this.gsp.eventBus.requestFor('FileTreePanelPackage', 'projectCreate', 'AccessFileTree', { action: '6' }, function (nodeInfo) {
                console.log(nodeInfo);
                comp_1.setProjType('backend');
                if (!nodeInfo.nodePath) {
                    comp_1.setPath('/');
                }
                if (nodeInfo.nodeType === 'folder' || nodeInfo.nodeType === 'project') {
                    setTimeout(function () { return comp_1.setPath(nodeInfo.nodePath); }, 100);
                }
                else if (nodeInfo.nodeType === 'file') {
                    var p = nodeInfo.nodePath.replace(/\\/g, '/');
                ...
                var modalPanel = _this.gsp.workspace.addModalPanel({ item: {
                        element: ele_1,
                        modalOptions: {
                            title: title,
                            width: 500,
                ...
                comp_1.modalClosed.subscribe(function () { return modalPanel.destroy(); });
            });
        }
        else if (tag === 2) {
            var packageView = new __WEBPACK_IMPORTED_MODULE_2__views_projectimportpackageview__["ProjectImportWizardPackageView"](state, this.cfr, this.injector);
            var ele = packageView.getElement();
            var comp = ele.instance;
            comp.importProjectSuccess.subscribe(function (nodeInfo) {
                _this.refreshFileTree();
                // this.addNewTreeNode(nodeInfo);
            });
            var height1 = window.innerHeight;
            var modalPanel_1 = this.gsp.workspace.addModalPanel({
                item: {
                    element: ele,
                    modalOptions: {
                        title: title,
                        width: 730,
                        height: height1 - 15 > 700 ? 700 : height1 - 15,
                        buttons: comp.btns
                    }
                }
            });
            comp.modalClosed.subscribe(function () { return modalPanel_1.destroy(); });
        }
        else if (tag === 3) {
            var packageView = new __WEBPACK_IMPORTED_MODULE_1__views_projectwizardpackageview__["ProjectWizardPackageView"](state, this.cfr, this.injector);
            var ele_2 = packageView.getElement();
            var comp_2 = ele_2.instance;
            comp_2.createProjectSuccess.subscribe(function (nodeInfo) {
                if (nodeInfo === 1) {
                    _this.refreshFileTree();
                }
                else {
            ...
            this.gsp.eventBus.requestFor('FileTreePanelPackage', 'projectCreate', 'AccessFileTree', { action: '6' }, function (nodeInfo) {
                console.log(nodeInfo);
                comp_2.setProjType('frontend');
                if (!nodeInfo.nodePath) {
                    comp_2.setPath('/');
                }
                if (nodeInfo.nodeType === 'folder' || nodeInfo.nodeType === 'project') {
                    setTimeout(function () { return comp_2.setPath(nodeInfo.nodePath); }, 100);
                }
                else if (nodeInfo.nodeType === 'file') {
                    var p = nodeInfo.nodePath.replace(/\\/g, '/');
                    p = p.substring(0, p.lastIndexOf('/'));
                ...
                var modalPanel = _this.gsp.workspace.addModalPanel({
                    item: {
                        element: ele_2,
                        modalOptions: {
                            title: title,
                ...
                comp_2.modalClosed.subscribe(function () { return modalPanel.destroy(); });
            });
        }
    };
    ProjectWizardPackage.prototype.deleteProject = function () {
        var _this = this;
        this.gsp.eventBus.requestFor('FileTreePanelPackage', 'projectCreate', 'AccessFileTree', { action: '6' }, function (nodeInfo) {
            console.log(nodeInfo);
            if (nodeInfo.nodeType === 'project' || nodeInfo.nodeType === 'folder') {
                _this.metadataService.DeleteProject(nodeInfo.nodePath.substring(1)).subscribe(function (data) {
                    alert('删除成功');
                    // 删除树节点
...
/***/ "./src/packages/project-wizard/project-package.module.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectWizardPackageModule", function() { return ProjectWizardPackageModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_project_project_component__ = __webpack_require__("./src/packages/project-wizard/views/project/project.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__package__ = __webpack_require__("./src/packages/project-wizard/package.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_projectimport_projectimport_component__ = __webpack_require__("./src/packages/project-wizard/views/projectimport/projectimport.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__project_service__ = __webpack_require__("./src/packages/project-wizard/project.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_primeng_checkbox__ = __webpack_require__("./node_modules/primeng/checkbox.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_primeng_checkbox___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_primeng_checkbox__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__progress_kendo_angular_inputs__ = __webpack_require__("./node_modules/@progress/kendo-angular-inputs/dist/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__gsp_lcm_metadata_selector__ = __webpack_require__("./node_modules/@gsp-lcm/metadata-selector/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__gsp_lcm_metadata_selector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__gsp_lcm_metadata_selector__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__farris_ui__ = __webpack_require__("./node_modules/@farris/ui/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__farris_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__farris_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__gsp_lcm_bo_selector__ = __webpack_require__("./node_modules/@gsp-lcm/bo-selector/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__gsp_lcm_bo_selector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16__gsp_lcm_bo_selector__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ProjectWizardPackageModule = (function (_super) {
    __extends(ProjectWizardPackageModule, _super);
    function ProjectWizardPackageModule(cfr, injector) {
        var _this = _super.call(this) || this;
        _this.cfr = cfr;
        _this.injector = injector;
        return _this;
    }
    ProjectWizardPackageModule.prototype.initPackage = function (gsp) {
        this.package = new __WEBPACK_IMPORTED_MODULE_7__package__["ProjectWizardPackage"](gsp, this.cfr, this.injector);
    };
    ProjectWizardPackageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_2__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_1__farris_ide_devkit__["ModalModule"].forRoot(),
                __WEBPACK_IMPORTED_MODULE_1__farris_ide_devkit__["PopoverModule"].forRoot(),
                __WEBPACK_IMPORTED_MODULE_13__gsp_lcm_metadata_selector__["GSPMetadataServiceModule"].forRoot(__WEBPACK_IMPORTED_MODULE_14__environments_environment__["environment"].SERVER_IP),
                ...
                __WEBPACK_IMPORTED_MODULE_11_primeng_checkbox__["CheckboxModule"],
                __WEBPACK_IMPORTED_MODULE_12__progress_kendo_angular_inputs__["InputsModule"],
                __WEBPACK_IMPORTED_MODULE_16__gsp_lcm_bo_selector__["BOSelectPackageModule"].forRoot(__WEBPACK_IMPORTED_MODULE_14__environments_environment__["environment"].SERVER_IP),
                __WEBPACK_IMPORTED_MODULE_15__farris_ui__["FarrisDialogModule"],
                __WEBPACK_IMPORTED_MODULE_15__farris_ui__["NotifyModule"].forRoot()
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_6__views_project_project_component__["ProjectComponent"], __WEBPACK_IMPORTED_MODULE_8__views_projectimport_projectimport_component__["ProjectimportComponent"]],
            declarations: [__WEBPACK_IMPORTED_MODULE_6__views_project_project_component__["ProjectComponent"], __WEBPACK_IMPORTED_MODULE_8__views_projectimport_projectimport_component__["ProjectimportComponent"]],
            providers: [__WEBPACK_IMPORTED_MODULE_9__project_service__["ProjectService"], __WEBPACK_IMPORTED_MODULE_1__farris_ide_devkit__["GSP"]],
            entryComponents: [__WEBPACK_IMPORTED_MODULE_6__views_project_project_component__["ProjectComponent"], __WEBPACK_IMPORTED_MODULE_8__views_projectimport_projectimport_component__["ProjectimportComponent"]]
        }),
    ...
    ], ProjectWizardPackageModule);
    return ProjectWizardPackageModule;
}(__WEBPACK_IMPORTED_MODULE_1__farris_ide_devkit__["PackageModule"]));

//# sourceMappingURL=project-package.module.js.map

/***/ }),

/***/ "./src/packages/project-wizard/project.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__projectimportersadapter__ = __webpack_require__("./src/packages/project-wizard/projectimportersadapter.ts");
...
var PROJECTS_IMPORTERS = 'api/dev/main/v1.0/project-importers';
var PROJECTS_IMPORT = 'api/dev/main/v1.0/project/import';
var ProjectService = (function () {
    function ProjectService(httpClient, http) {
        this.httpClient = httpClient;
        this.http = http;
    }
    ProjectService.prototype.getImportersUrl = function () {
        return SERVER_IP + PROJECTS_IMPORTERS;
    };
    ProjectService.prototype.getImportProjUrl = function () {
        return SERVER_IP + PROJECTS_IMPORT;
    };
    ProjectService.prototype.getRootPathUrl = function () {
        return SERVER_IP + 'api/dev/main/v1.0/project/rootpath';
    };
    ProjectService.prototype.getRootPath = function () {
        var url = this.getRootPathUrl();
        var importers = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["Subject"]();
        this.httpClient.get(url, { 'responseType': 'text' }).subscribe(function (result) {
            console.log(result);
            if (result) {
                importers.next(result.toString());
            }
        });
        return importers;
    };
    ProjectService.prototype.getImportTypes = function () {
        var url = this.getImportersUrl();
        var importers = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["Subject"]();
        this.httpClient.get(url).subscribe(function (result) {
            var adapter = new __WEBPACK_IMPORTED_MODULE_4__projectimportersadapter__["ProjectImportersAdapter"](result);
            var data = adapter.getImporters();
            if (data) {
                importers.next(data);
            }
        });
    ...
    ProjectService.prototype.importProject = function (wspath, body) {
        var url = this.getImportProjUrl() + '/' + wspath;
        console.log(url);
        return this.httpClient.post(url, body);
    };
    // 新建工程
    ProjectService.prototype.createProject = function (options) {
        var content = {
            'type': options.type,
        ...
        var resOptions = new __WEBPACK_IMPORTED_MODULE_5__angular_http__["RequestOptions"]({
            params: {},
            headers: headers
        });
        var url = SERVER_IP + 'api/dev/main/v1.0/project?name=' + options.name + '&nameSpace=' + options.nameSpace +
            '&packageName=' + options.packageName + '&targetFramework=' + options.targetFramework + '&conditionRelease=' +
            options.conditionRelease + '&conditionDebug=' + options.conditionDebug + '&outputPath=' + options.outputPath +
            '&boid=' + options.boID + '&appCode=' + options.appCode + '&suCode=' + options.suCode + '&boCode=' +
            options.boCode + '&suDeploymentPath=' + options.suDeploymentPath + '&projType=' + options.projType;
        return this.http.post(url, content, resOptions);
    };
    // 获取SU部署路径
    ProjectService.prototype.getSuDeploymentPath = function (appCode, suCode) {
        return 'apps/' + appCode + '/' + suCode;
    };
    ProjectService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["HttpClient"], __WEBPACK_IMPORTED_MODULE_5__angular_http__["Http"]])
    ], ProjectService);
...
/***/ "./src/packages/project-wizard/project.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectOptions", function() { return ProjectOptions; });
...
/***/ "./src/packages/project-wizard/projectimporters.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectImporters", function() { return ProjectImporters; });
var ProjectImporters = (function () {
    function ProjectImporters() {
    }
    return ProjectImporters;
}());
...
/***/ "./src/packages/project-wizard/projectimportersadapter.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectImportersAdapter", function() { return ProjectImportersAdapter; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__projectimporters__ = __webpack_require__("./src/packages/project-wizard/projectimporters.ts");

var ProjectImportersAdapter = (function () {
    function ProjectImportersAdapter(importersReqResult) {
        this.importersReqResult = importersReqResult;
    }
    ProjectImportersAdapter.prototype.getImporters = function (importersReqResult) {
        if (importersReqResult === void 0) { importersReqResult = this.importersReqResult; }
        if (importersReqResult == null) {
            return null;
        }
        var projImps = [];
        var defaultTag = importersReqResult.configuration['default-importer'];
        importersReqResult.importers.forEach(function (imp) {
            var importer = new __WEBPACK_IMPORTED_MODULE_0__projectimporters__["ProjectImporters"]();
            importer.id = imp.id.toLowerCase();
            importer.category = imp.category;
            importer.internal = imp.internal;
            importer.description = imp.description;
            importer.default = false;
            if (defaultTag && defaultTag === imp.id) {
                importer.default = true;
            }
            projImps.push(importer);
        });
        return projImps;
    };
    return ProjectImportersAdapter;
}());
...
/***/ "./src/packages/project-wizard/views/project/project.component.css":
/***/ (function(module, exports, __webpack_require__) {

exports = module.exports = __webpack_require__("./node_modules/css-loader/lib/css-base.js")(false);
// imports
exports.i(__webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"sourceMap\":false}!./src/assets/primeng/css/primeng.min.css"), "");
...
/***/ "./src/packages/project-wizard/views/project/project.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"infoBlock\">\r\n  <label class=\"rootpath\"> 开发根路径：{{rootPath}}</label>\r\n  <button kendoButton class=\"btn-biz\" (click)=\"openBoSelect()\">选择业务对象</button>\r\n  <div class=\"filePath\">\r\n    <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">存放位置</label>\r\n    </div>\r\n    <input id=\"filePath\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.project.path\"\r\n      #filePath=\"ngModel\" required />\r\n    <div [hidden]=\"filePath.valid || filePath.pristine\" class=\"alert-danger\">\r\n      Path is required\r\n    </div>\r\n  </div>\r\n  <div class=\"appCode\">\r\n      <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">关键应用编号</label>\r\n      <button type=\"button\" class=\"k-button k-bare\"  triggers=\"mouseenter:mouseleave\"\r\n      popover=\"如SCM\" container=\"body\" style=\"position: relative;top: -2px;\">\r\n        <i class=\"fa fa-question-circle\"></i>\r\n      </button>\r\n      </div>\r\n      <input id=\"appCode\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"project.appCode\" #appCode=\"ngModel\" (ngModelChange)=\"setAppCode()\">\r\n    <div [hidden]=\"appCode.valid || appCode.pristine\" class=\"alert-danger\">\r\n        appCode is required\r\n    </div>\r\n  </div>\r\n  <div class=\"suCode\">\r\n      <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">SU编号</label>\r\n      <button type=\"button\" class=\"k-button k-bare\"  triggers=\"mouseenter:mouseleave\"\r\n      popover=\"如SD\" container=\"body\" style=\"position: relative;top: -2px;\">\r\n        <i class=\"fa fa-question-circle\"></i>\r\n      </button>\r\n      </div>\r\n        <input id=\"suCode\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"project.suCode\" #suCode=\"ngModel\" (ngModelChange)=\"setSuCode()\">\r\n      <div [hidden]=\"suCode.valid || suCode.pristine\" class=\"alert-danger\">\r\n          suCode is required\r\n      </div>\r\n  </div>\r\n  <div class=\"boCode\">\r\n      <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">BO编号</label>\r\n      <button type=\"button\" class=\"k-button k-bare\"  triggers=\"mouseenter:mouseleave\"\r\n        popover=\"请使用系统预置的业务对象编号，如salesorder\" container=\"body\" style=\"position: relative;top: -2px;\">\r\n          <i class=\"fa fa-question-circle\"></i>\r\n        </button>\r\n      </div>\r\n        <input id=\"boCode\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"project.boCode\" #boCode=\"ngModel\" (ngModelChange)=\"setBoCode()\">\r\n      <div [hidden]=\"boCode.valid || boCode.pristine\" class=\"alert-danger\">\r\n          boCode is required\r\n      </div>\r\n    </div>\r\n  <div class=\"fileName\">\r\n    <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">工程名称</label>\r\n      <button type=\"button\" class=\"k-button k-bare\" triggers=\"mouseenter:mouseleave\" popover=\"元数据工程文件名称，工程内容名称，使用“bo-”+“业务对象code小写”，仅能包含字母、数字、小数点以及中划线，如bo-salesorder\"\r\n        container=\"body\" style=\"position: relative;top: -2px;\">\r\n        <i class=\"fa fa-question-circle\"></i>\r\n      </button>\r\n    </div>\r\n    <input id=\"fileName\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.project.name\"\r\n      #fileName=\"ngModel\" required />\r\n    <div [hidden]=\"fileName.valid || fileName.pristine\" class=\"alert-danger\">\r\n      Code is required\r\n    </div>\r\n  </div>\r\n  <div class=\"nameSpace\">\r\n    <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">元数据命名空间</label>\r\n      <button type=\"button\" class=\"k-button k-bare\" triggers=\"mouseenter:mouseleave\" popover=\"元数据工程命名空间，默认使用bo对应的命名空间，仅能包含字母数字及小数点，如Inspur.GS.Scm.SD.SalesOrder\"\r\n        container=\"body\" style=\"position: relative;top: -2px;\">\r\n        <i class=\"fa fa-question-circle\"></i>\r\n      </button>\r\n    </div>\r\n    <input id=\"nameSpace\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.project.nameSpace\"\r\n      #nameSpace=\"ngModel\" required>\r\n    <div [hidden]=\"nameSpace.valid || nameSpace.pristine\" class=\"alert-danger\">\r\n      NameSpace is required\r\n    </div>\r\n  </div>\r\n  <div class=\"packageName\">\r\n    <div class=\"titleProject\">\r\n      <label class=\"frameInfo\">元数据包名</label>\r\n      <button type=\"button\" class=\"k-button k-bare\" triggers=\"mouseenter:mouseleave\" popover=\"元数据包名称，类似于dll名称，运行时是唯一的，默认使用元数据工程命名空间，仅能包含字母数字及小数点，如Inspur.GS.Scm.SD.SalesOrder\"\r\n        container=\"body\" style=\"position: relative;top: -2px;\">\r\n        <i class=\"fa fa-question-circle\"></i>\r\n      </button>\r\n    </div>\r\n    <input id=\"packageName\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.project.packageName\"\r\n      #packageName=\"ngModel\" required>\r\n    <div [hidden]=\"packageName.valid || packageName.pristine\" class=\"alert-danger\">\r\n      PackageName is required\r\n    </div>\r\n  </div>\r\n  <!-- <div class=\"fileDescription\">\r\n    <div class=\"title\">\r\n      <label class=\"frameInfo\">描述</label>\r\n    </div>\r\n    <input id=\"fileDescription\" class=\"form-control textInput\" type=\"text\" kendoTextBox [(ngModel)]=\"this.project.description\"\r\n      #fileDescription=\"ngModel\">\r\n  </div> -->\r\n</div>\r\n\r\n<ng-template #btn>\r\n  <button type=\"button\" class=\"btn btn-outline-primary btn-sm px-3 mx-2\" (click)=\"clickOK()\">确定</button>\r\n  <button type=\"button\" class=\"btn btn-outline-secondary btn-sm px-3 mx-2\" (click)=\"clickCancel()\">取消</button>\r\n  <!-- <button (click)=\"clickOK()\">确定</button>\r\n  <button (click)=\"clickCancel()\">取消</button> -->\r\n</ng-template>"

/***/ }),

/***/ "./src/packages/project-wizard/views/project/project.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__project_service__ = __webpack_require__("./src/packages/project-wizard/project.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gsp_lcm_metadata_selector__ = __webpack_require__("./node_modules/@gsp-lcm/metadata-selector/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gsp_lcm_metadata_selector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__gsp_lcm_metadata_selector__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gsp_lcm_bo_selector__ = __webpack_require__("./node_modules/@gsp-lcm/bo-selector/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gsp_lcm_bo_selector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__gsp_lcm_bo_selector__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__project__ = __webpack_require__("./src/packages/project-wizard/project.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProjectComponent = (function () {
    function ProjectComponent(cache, projService, metadataservice, modalService, resolver, injector, notifyService) {
        var _this = this;
        this.cache = cache;
        ...
        this.createProjectSuccess = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.rootPath = '';
        this.projType = 'backend';
        ...
        this.project = {
            ...
            conditionRelease: "\"'$(Configuration)|$(Platform)'=='Release|AnyCPU'\"",
            conditionDebug: "\"'$(Configuration)|$(Platform)'=='Debug|AnyCPU'\"",
            outputPath: 'bin\\',
            packageName: '',
            description: ''
        };
        this.projService.getRootPath().subscribe(function (path) {
            _this.rootPath = path;
        });
    }
    ...
    ProjectComponent.prototype.setPath = function (path) {
        this.project.path = path.replace(/\\/g, '/');
    };
    ProjectComponent.prototype.setProjType = function (projType) {
        this.projType = projType;
    };
    ProjectComponent.prototype.setAppCode = function () {
        if (this.project.suCode && this.project.boCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        }
        else if (this.project.suCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode;
        }
        else if (this.project.boCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.boCode;
        }
        else {
            this.project.nameSpace = this.prefix + this.project.appCode;
        }
        // this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        this.project.packageName = this.project.nameSpace;
    };
    ProjectComponent.prototype.setSuCode = function () {
        if (this.project.appCode && this.project.boCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        }
        else if (this.project.appCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode;
        }
        else if (this.project.boCode) {
            this.project.nameSpace = this.prefix + this.project.suCode + '.' + this.project.boCode;
        }
        else {
            this.project.nameSpace = this.prefix + this.project.suCode;
        }
        // this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        this.project.packageName = this.project.nameSpace;
    };
    ProjectComponent.prototype.setBoCode = function () {
        if (this.project.appCode && this.project.suCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        }
        else if (this.project.appCode) {
            this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.boCode;
            ...
            this.project.nameSpace = this.prefix + this.project.boCode;
        }
        // this.project.nameSpace = this.prefix + this.project.appCode + '.' + this.project.suCode + '.' + this.project.boCode;
        this.project.packageName = this.project.nameSpace + (this.projType === 'frontend' ? '.front' : '');
        this.project.name = 'bo-' + this.project.boCode + (this.projType === 'frontend' ? '-front' : '');
    };
    // 新建工程
    ProjectComponent.prototype.createProject = function () {
        var _this = this;
        var importState = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        var selectType = 'folder'; // this.workspace.fileTreeActivedNodeType;
        if (selectType === undefined || selectType === 'folder' || selectType === 'project') {
            var attributes = {};
            var type = 'gs';
            var name_1 = this.project.name;
            var reg = new RegExp('^[a-zA-Z-.\x7f-\xff][a-zA-Z0-9-.\x7f-\xff]*$');
            var reg2 = new RegExp('^[a-zA-Z0-9.\x7f-\xff]*$');
            if (!name_1) {
                alert('工程名称不能为空！');
                return importState;
            }
            else if (!reg.test(name_1)) {
                alert('工程名称包含非法字符，请重新输入');
                return importState;
            }
            var appCode = this.project.appCode;
            if (!appCode) {
                alert('关键应用不能为空！');
                return importState;
            }
            var suCode = this.project.suCode;
            if (!suCode) {
                alert('服务单元不能为空！');
                return importState;
            }
            var boCode = this.project.boCode;
            if (!boCode) {
                alert('业务对象不能为空！');
                return importState;
            }
            if (!this.project.boID) {
                this.project.boID = boCode;
            }
            var nameSpace = this.project.nameSpace;
            if (!nameSpace) {
                alert('命名空间不能为空！');
                return importState;
            }
            else if (!reg2.test(nameSpace)) {
                alert('工程命名空间包含非法字符，请重新输入');
                return importState;
            }
            var packageName = this.project.packageName;
            if (!packageName) {
                alert('包名不能为空！');
                return importState;
            }
            else if (!reg2.test(packageName)) {
                alert('元数据包名包含非法字符，请重新输入');
                return importState;
            }
            var path = '';
            if (this.project.path === '/') {
                path = this.project.path + name_1;
            }
            else {
                path = this.project.path + '/' + name_1;
            }
            ...
            // 部署路径与配置文件路径检测
            if (!this.project.suDeploymentPath) {
                this.project.suDeploymentPath = this.projService.getSuDeploymentPath(this.project.appCode, this.project.suCode);
            }
            var options = new __WEBPACK_IMPORTED_MODULE_7__project__["ProjectOptions"]();
            options.appCode = this.project.appCode;
            options.projType = this.projType;
            options.suDeploymentPath = this.project.suDeploymentPath;
            options.boID = this.project.boID;
            options.type = type;
            ...
            options.boCode = this.project.boCode;
            options.targetFramework = this.project.targetFramework;
            options.conditionRelease = this.project.conditionRelease;
            options.conditionDebug = this.project.conditionDebug;
            options.outputPath = this.project.outputPath;
            options.suCode = this.project.suCode;
            this.projService.createProject(options).subscribe(function (result) {
                // this.notifyService.success(<NotifyOptions>{ title: '系统提示', msg: '新建成功。', timeout: 1000 });
                alert('新建成功。');
                importState.next(true);
                if (_this.project.path === '/') {
                    _this.createProjectSuccess.emit(1);
                }
                else {
                    _this.createProjectSuccess.emit({
                        action: '1',
                        node: {
                            nodeID: name_1,
                            nodeName: name_1,
                            nodePath: _this.project.path + '/' + name_1,
                            nodeType: 'project'
                        }
                    });
                }
                ...
                alert('新建失败。');
                // this.notifyService.error(<NotifyOptions>{ title: '系统提示', msg: '新建失败。', timeout: 1000 });
                importState.next(false);
            });
            return importState;
        }
        else {
    ...
    ProjectComponent.prototype.clickOK = function () {
        this.createProject();
    };
    ProjectComponent.prototype.onSelectBO = function () {
        // alert('on');
        this.selectBO.emit();
    };
    ProjectComponent.prototype.setBO = function (data) {
        var _this = this;
        this.metadataservice.GetDevBasicBOInfo(data.id, this.sessionId).subscribe(function (item) {
            _this.project.appCode = item.appCode;
            _this.project.suCode = item.suCode;
            _this.project.boCode = item.boInfo.code;
            _this.project.boID = item.boInfo.id;
            _this.project.name = 'bo-' + item.boInfo.code + (_this.projType === 'frontend' ? '-front' : '');
            // this.project.nameSpace = 'Inspur.GS.' + item.boInfo.appCode + '.' + item.boInfo.suCode + '.' + item.boInfo.boCode;
            _this.project.nameSpace = item.boNameSpace + (_this.projType === 'frontend' ? '.front' : '');
            _this.project.packageName = _this.project.nameSpace;
            _this.project.suDeploymentPath = item.suInfo.applicationPath;
        });
    };
    ProjectComponent.prototype.clickCancel = function () {
        this.modalClosed.emit();
    };
    ProjectComponent.prototype.openBoSelect = function () {
        var _this = this;
        var compFactory = this.resolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_5__gsp_lcm_bo_selector__["BusinessObjectsSelectComponent"]);
        var compRef = compFactory.create(this.injector);
        compRef.instance.selectedBOEvent.subscribe(function ($event) {
        ...
        compRef.instance.modalClosed.subscribe(function ($event) {
            dialog.close();
        });
    };
    __decorate([
    ...
    ], ProjectComponent.prototype, "btns", void 0);
    ProjectComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-project',
            template: __webpack_require__("./src/packages/project-wizard/views/project/project.component.html"),
            styles: [__webpack_require__("./src/packages/project-wizard/views/project/project.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__farris_ide_devkit_services__["CacheService"], __WEBPACK_IMPORTED_MODULE_2__project_service__["ProjectService"],
            __WEBPACK_IMPORTED_MODULE_3__gsp_lcm_metadata_selector__["GSPMetadataService"], __WEBPACK_IMPORTED_MODULE_6__farris_ui__["BsModalService"],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["ComponentFactoryResolver"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"], __WEBPACK_IMPORTED_MODULE_6__farris_ui__["NotifyService"]])
    ], ProjectComponent);
...
/***/ "./src/packages/project-wizard/views/projectimport/projectimport.component.css":
/***/ (function(module, exports, __webpack_require__) {

exports = module.exports = __webpack_require__("./node_modules/css-loader/lib/css-base.js")(false);
// imports
exports.i(__webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"sourceMap\":false}!./src/assets/primeng/css/primeng.min.css"), "");
exports.i(__webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!./node_modules/postcss-loader/lib/index.js?{\"ident\":\"postcss\",\"sourceMap\":false}!./src/assets/primeng/themes/omega/theme.css"), "");
...
/***/ "./src/packages/project-wizard/views/projectimport/projectimport.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"k-i-loading\" *ngIf=\"this.isLoading\"></div>\r\n<div *ngIf='importersData.length > 0'>\r\n  <kendo-splitter class=\"leftPane\">\r\n    <kendo-splitter-pane [resizable]=\"false\" size=\"40%\">\r\n      <kendo-grid [data]=\"importersData\" [selectable]=\"selectableSettings\" (selectionChange)=\"selectionChange($event)\" [rowSelected]=\"isRowSelected\">\r\n        <kendo-grid-column field=\"id\" title=\"import types\"></kendo-grid-column>\r\n      </kendo-grid>\r\n    </kendo-splitter-pane>\r\n\r\n    <kendo-splitter-pane [resizable]=\"false\">\r\n      <div class=\"infoBlock\" *ngIf=\"this.selectedItem\">\r\n        <div *ngIf=\"this.selectedItem && this.selectedItem.description\">\r\n          <h6>Importer Information</h6>\r\n          <label>{{this.selectedItem.description}}</label>\r\n        </div>\r\n        <div class=\"url\">\r\n          <label>URL:</label>\r\n          <br/>\r\n          <input id=\"url\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.remoteUrl\" #url=\"ngModel\"\r\n            required (onChange)=\"onUrlChanged($event)\">\r\n          <div [hidden]=\"url.valid || url.pristine\" class=\"alert-danger\">\r\n            Url is required\r\n          </div>\r\n        </div>\r\n        <p-checkbox *ngIf=\"this.selectedItem && this.selectedItem.id == 'git'\" class='labelStandard' name=\"group1\" label=\"Import resursively(for multi-module projects)\"\r\n          [(ngModel)]=\"importRecursivelyFlag\" binary=\"true\"></p-checkbox>\r\n        <div>\r\n          <h6>Project Information</h6>\r\n        </div>\r\n        <div class=\"name\">\r\n          <label>Project Name:</label>\r\n          <br/>\r\n          <input id=\"name\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.projectName\" #name=\"ngModel\"\r\n            required>\r\n          <div [hidden]=\"name.valid || name.pristine\" class=\"alert-danger\">\r\n            Name is required\r\n          </div>\r\n        </div>\r\n        <label>Description:</label>\r\n        <br/>\r\n        <textarea class='textInput' [rows]=\"3\" [cols]=\"30\" kendoTextArea autoResize=false style='resize:none' [(ngModel)]=\"this.description\"></textarea>\r\n        <div *ngIf=\"this.selectedItem && this.selectedItem.id == 'zip'\">\r\n          <p-checkbox class='labelStandard' name=\"group3\" label=\"Skip the root folder of the archive\" [(ngModel)]=\"skipRoot\" binary=\"true\"></p-checkbox>\r\n        </div>\r\n        <div *ngIf=\"this.selectedItem && (this.selectedItem.id == 'git' || this.selectedItem.id == 'github')\">\r\n          <div class=\"branch\">\r\n            <p-checkbox class='labelStandard' name=\"group2\" label=\"Branch\" [(ngModel)]=\"branchFlag\" binary=\"true\" (onChange)=\"onBranchFlagChanged($event)\"></p-checkbox>\r\n            <br/>\r\n            <label>Branch Name:</label>\r\n            <br/>\r\n            <input id=\"branchName\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.branchName\" [disabled]=\"!branchEnable\">\r\n          </div>\r\n          <div>\r\n            <div>\r\n              <h6>Permission</h6>\r\n            </div>\r\n            <div class=\"username\">\r\n              <label>User Name:</label>\r\n              <br/>\r\n              <input id=\"username\" class=\"form-control textInput\" type=\"text\" size=\"30\" kendoTextBox [(ngModel)]=\"this.userName\" #username=\"ngModel\">\r\n              <div [hidden]=\"username.valid || username.pristine\" class=\"alert-danger\">\r\n                UserName is required\r\n              </div>\r\n            </div>\r\n            <div class=\"passwd\">\r\n              <label>Password:</label>\r\n              <br/>\r\n              <input class=\"form-control textInput\" type=\"password\" pPassword [(ngModel)]=\"password\" feedback=false />\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </kendo-splitter-pane>\r\n  </kendo-splitter>\r\n</div>\r\n<ng-template #btn>\r\n  <button type=\"button\" class=\"btn btn-outline-primary btn-sm px-3 mx-2\" (click)=\"clickOK()\">Confirm</button>\r\n  <button type=\"button\" class=\"btn btn-outline-secondary btn-sm px-3 mx-2\" (click)=\"clickCancel()\">Cancel</button>\r\n</ng-template>\r\n<farris-notify-container></farris-notify-container>"

/***/ }),

/***/ "./src/packages/project-wizard/views/projectimport/projectimport.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__project_service__ = __webpack_require__("./src/packages/project-wizard/project.service.ts");
...
var ProjectimportComponent = (function () {
    function ProjectimportComponent(projectService, notifyService) {
        var _this = this;
        this.projectService = projectService;
        this.notifyService = notifyService;
        this.importProjectSuccess = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.modalClosed = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.cols = [
            { field: 'id', header: '导入方式' }
        ];
        this.importersData = [];
        this.selectedItem = { id: 'git', 'description': '' };
        this.importRecursivelyFlag = false;
        ...
        this.branchName = '';
        this.skipRoot = false;
        this.branchEnable = false;
        this.msgs = [];
        this.isLoading = false;
        this.isRowSelected = function (e) { return e.dataItem.id === _this.selectedItem.id; };
        this.selectableSettings = {
            checkboxOnly: false,
            mode: 'single',
            enabled: true
        };
        this.projectService.getImportTypes().subscribe(function (result) {
            _this.importersData = result;
            if (_this.importersData) {
                _this.importersData = _this.importersData.sort(function (a, b) { return a.category - b.category; });
            }
            _this.selectedItem = result.find(function (res) { return res.default; });
            // this.updateRowGroupMetaData();
        });
    }
    ProjectimportComponent.prototype.selectionChange = function (event) {
    ...
    ProjectimportComponent.prototype.onUrlChanged = function (event) {
        console.log(event);
    };
    // 新建工程
    ProjectimportComponent.prototype.importProject = function () {
        var _this = this;
        var importState = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Subject"]();
        if (!this.validateData()) {
            return importState;
        }
        var parameters = {};
        if (this.selectedItem.id === 'git' || this.selectedItem.id === 'github') {
            parameters['username'] = this.userName;
            parameters['password'] = this.password;
            if (this.branchFlag) {
                parameters['branch'] = this.branchName;
            }
            if (this.importRecursivelyFlag) {
                parameters['recursive'] = this.importRecursivelyFlag;
            }
        }
        else {
            parameters['skipFirstLevel'] = this.skipRoot;
        }
        var body = {
            'location': this.remoteUrl,
            'type': this.selectedItem.id,
            parameters: parameters
        };
        this.isLoading = true;
        this.projectService.importProject(this.projectName, body).subscribe(function (result) {
            console.log('success');
            // this.notifyService.success(<NotifyOptions>{ title: '系统提示', msg: '创建成功。', timeout: 1000 });
            alert('创建成功。');
            _this.isLoading = false;
            importState.next(true);
            _this.importProjectSuccess.emit({
                action: '1',
                node: {
                    nodeID: _this.projectName,
                    nodeName: _this.projectName,
                    nodePath: '/' + _this.projectName,
                    nodeType: 'project'
                }
            });
            // close
            ...
            // this.notifyService.error(<NotifyOptions>{ title: '系统提示', msg: '创建失败。', timeout: 1000 });
            alert('创建失败，内部错误。');
            importState.next(false);
        });
        return importState;
    ...
    // 校验
    ProjectimportComponent.prototype.validateData = function () {
        if (!this.selectedItem || !this.selectedItem.id) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'Please select an import type.' }];
            this.notifyService.error({ title: '系统提示', msg: '请选择导入方式。', timeout: 1000 });
            return false;
        }
        if (!this.remoteUrl) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'URL can not be empty.' }];
            this.notifyService.error({ title: '系统提示', msg: 'URL地址不能为空。', timeout: 1000 });
            return false;
        }
        if (!this.projectName) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'Project Name can not be empty.' }];
            this.notifyService.error({ title: '系统提示', msg: '工程名不能为空。', timeout: 1000 });
            return false;
        }
        if (this.selectedItem.id === 'git' && this.branchEnable === true && !this.branchName) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'Branch Name can not be empty.' }];
            this.notifyService.error({ title: '系统提示', msg: '分支名不能为空。', timeout: 1000 });
            return false;
        }
        if (this.selectedItem.id === 'git' && !this.userName) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'User Name can not be empty.' }];
            this.notifyService.error({ title: '系统提示', msg: '用户名不能为空。', timeout: 1000 });
            return false;
        }
        if (this.selectedItem.id === 'git' && !this.password) {
            // this.msgs = [{ severity: 'info', summary: 'Notification', detail: 'Password can not be empty.' }];
            this.notifyService.error({ title: '系统提示', msg: '密码不能为空。', timeout: 1000 });
            return false;
        }
        return true;
    };
    // 填写分支名
    ProjectimportComponent.prototype.onBranchFlagChanged = function (checked) {
        if (checked) {
            this.branchEnable = true;
        }
        else {
            this.branchEnable = false;
        }
    };
    ProjectimportComponent.prototype.clickOK = function () {
        this.importProject();
    };
    ProjectimportComponent.prototype.clickCancel = function () {
        this.modalClosed.emit();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('btn'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["TemplateRef"])
    ], ProjectimportComponent.prototype, "btns", void 0);
    ProjectimportComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-projectimport',
            template: __webpack_require__("./src/packages/project-wizard/views/projectimport/projectimport.component.html"),
            styles: [__webpack_require__("./src/packages/project-wizard/views/projectimport/projectimport.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__project_service__["ProjectService"], __WEBPACK_IMPORTED_MODULE_3__farris_ui__["NotifyService"]])
...
/***/ "./src/packages/project-wizard/views/projectimportpackageview.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectImportWizardPackageView", function() { return ProjectImportWizardPackageView; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit__ = __webpack_require__("./node_modules/@farris/ide-devkit/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__projectimport_projectimport_component__ = __webpack_require__("./src/packages/project-wizard/views/projectimport/projectimport.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ProjectImportWizardPackageView = (function (_super) {
    __extends(ProjectImportWizardPackageView, _super);
    function ProjectImportWizardPackageView(serializedState, cfr, injector) {
        var _this = _super.call(this, serializedState) || this;
        _this.cfr = cfr;
        _this.injector = injector;
        _this.element = cfr.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_1__projectimport_projectimport_component__["ProjectimportComponent"]).create(injector);
        return _this;
    }
    return ProjectImportWizardPackageView;
...
/***/ "./src/packages/project-wizard/views/projectwizardpackageview.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectWizardPackageView", function() { return ProjectWizardPackageView; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit__ = __webpack_require__("./node_modules/@farris/ide-devkit/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__project_project_component__ = __webpack_require__("./src/packages/project-wizard/views/project/project.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ProjectWizardPackageView = (function (_super) {
    __extends(ProjectWizardPackageView, _super);
    function ProjectWizardPackageView(serializedState, cfr, injector) {
        var _this = _super.call(this, serializedState) || this;
        _this.cfr = cfr;
        _this.injector = injector;
        _this.element = cfr.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_1__project_project_component__["ProjectComponent"]).create(injector);
        return _this;
    }
    return ProjectWizardPackageView;
}(__WEBPACK_IMPORTED_MODULE_0__farris_ide_devkit__["PackageView"]));
...
},[],["businessobject","rxjs"],["businessobject","rxjs"]);
//# sourceMappingURL=project-package.module.chunk.js.map