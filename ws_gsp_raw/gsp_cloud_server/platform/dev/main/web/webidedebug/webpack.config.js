  ...
  return {
    ...
    "plugins": [
      new LazyRequirePlugin({
        entryModules:[
          // "app/modules/sales-order/sales-order.module.ts",
          // "app/modules/saleorderlist/saleorderlist.module.ts",
          // "app/modules/saleorder/saleorder.module.ts"
          filePath
        ],
      ...
      new LibReferencePlugin({
        ...
        reference: [
          ...
          ['progress','dist/progress_manifest.json']
        ],
